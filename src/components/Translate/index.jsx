...
export default function TranslateButton() {
    ...
    return <Button onClick={changeLang}>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-translate" style={{marginRight:"5px"}} viewBox="0 0 16 16">
